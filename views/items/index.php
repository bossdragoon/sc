            ...
            <div class="modal-content">
                <form class="form-horizontal" name="editForm" id="editForm" role="form" action="<?php echo URL; ?>productForm/" method="post">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="gridSystemModalLabel">เพิ่มรายการอุปกรณ์ใหม่</h4>
                    </div>
                    <div class="modal-body">
                        <div id="formAlert"></div>
                        
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="div_items_type">ประเภท :</label>
                        ...
                        <div class="form-group" >
                            <label class="control-label col-sm-2" for="div_items_name">ชื่ออุปกรณ์ :</label>
