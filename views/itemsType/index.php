...
<div class="container">
    <h1>จัดการชนิดอุปกรณ์</h1>
    <p>รายชื่อชนิดอุปกรณ์</p>
                ...
                <form class="form-horizontal" name="editForm" id="editForm" role="form" action="<?php echo URL; ?>productForm/" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group" >
                            <label class="control-label col-sm-2" for="div_items_type_id">ID :</label>
                            <div class="col-sm-7" id="div_items_type_id" name="div_items_type_id">
                                <input type="text" id="items_type_id" name="items_type_id" class="form-control" autocomplete="off" />
                            </div>
                        </div>
                        <div class="form-group" >
                            <label class="control-label col-sm-2" for="div_items_type_name">NAME :</label>
                            <div class="col-sm-7" id="div_items_type_name" name="div_items_type_name">
